...
<?php wp_nav_menu('menu=NastyMondays'); ?>		<hr />
				
<?php get_sidebar(); ?>

<?php get_template_part( 'segonquart' );  ?>
<h4 class="backstage"><a href="http://nastymondays.com/backstage/"><?php echo " &spades;  &spades;  &spades;  Visit Nasty Mondays Backstage. It's free and you'll meet Soren and Max &spades;  &spades;  &spades; " ?></a></h4>
<?php get_footer(); ?>
</div>	
</div>
</body>

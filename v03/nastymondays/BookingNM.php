...
<div id="pasador5">
    <div class="left">
        ...
        <h2 class="nasty2">
            ...
            <?php bloginfo ('name'); ?>: <?php print e_ ('El Choro &amp; El Max '); ?>
        ...
        <p> &spades; Book the mob <?php bloginfo ('name'); ?> for your room, in your city, at your unique and special event. From barcelona to Andorra and Switzerland with love. Panama rulez. Mob rulez. Laundry rulez <br />
            ...
            Snow Beasts, Tattoo Lovers, Night Dealers, Rats, Surf addicts, Rock Stars, Blonde Rotten Souls ... <br /> &spades; When do you want us to be there?
        </p>
    </div>

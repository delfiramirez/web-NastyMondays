...
<h2><?php print 'Please, login into your account' ?>
</h2>
<?php echo '<p id="signup">or <a href="/prensa/registro-prensa/" title="Signup for a'. $blogName .' Press account">Signup</a>|  for a' .$blogName .' Press account &raquo;</p>' ?>
</div>
</div>
<div id="tabla_prensa">
<div id="calendar">
